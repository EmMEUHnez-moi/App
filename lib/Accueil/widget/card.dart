...
void reserverTrajet(Map<String, String> Details){ // mettre le trajet dans mes trajets + occupe une place dans la voiture (liste avec les noms des passagers)

}

void rechercherTrajet(Map<String, String> Details){ // recherche le trajet dans l'accueil (trajets récents)
  
}

void ajoutOUsupprFavoris(Map<String, String> Details) { // si trajet ou utilisateur déjà dans favoris alors supprimer des favoris sinon ajouter aux favoris

}

void annulerTrajet(Map<String, String> Details) { // supprimer le trajet de mes trajets + libère une place dans la voiture (suppression du nom dans la liste des passagers)

}

void infoprofil(Map<String, String> Details) { // donne les informations de l'utilisateur
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: ListTile(
        ...
        title: Text('Prénom Nom : $utilisateur',style: TextStyle(color: Colors.white)),
